...
class GitReopenError extends ReopenError {
    constructor(message) {
        super(message);
        // Set the prototype explicitly.
        Object.setPrototypeOf(this, GitReopenError.prototype);
    }
}
...
function getTODOIssues(wd, conf) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (gitExitCode !== 0) {
            throw new GitReopenError(`git exited ${gitExitCode}: ${gitErr}: is ${wd} in a git checkout?`);
        }
